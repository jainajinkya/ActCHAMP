...
public:
	...
	// Active CHAMP
	virtual geometry_msgs::Pose predictPoseFromAction(size_t index);
	virtual double getLogLikelihoodForPoseIndexFromAction(size_t index);
	virtual double getInlierLogLikelihoodFromAction( size_t index);
	virtual double getLogLikelihoodFromAction(bool estimate_outlier_ratio);
	virtual bool evaluateModelFromAction();
};
