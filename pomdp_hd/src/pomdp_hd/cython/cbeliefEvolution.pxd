...
cdef extern from "../include/belief_evolution.h":
    cppclass BeliefEvolution:
        ...
        void setIntergationStepSize(double&)

        void getMatrices(int&, Map[VectorXd] &, Map[VectorXd] &, Map[MatrixXd]&, Map[MatrixXd]&, Map[MatrixXd]&, Map[MatrixXd]&, Map[MatrixXd]&)
        void forwardKinematicsMapped(int&, Map[VectorXd] &, Map[VectorXd] &)
        void inverseKinematicsMapped(int&, Map[VectorXd] &, Map[VectorXd] &)
        ...
        void setReferenceFrameMapped(Map[VectorXd] &)
